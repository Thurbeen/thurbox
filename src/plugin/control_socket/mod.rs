...
//!
//! - [`dispatch::dispatch`] is the pure-logic half. Given a `PluginRuntime` + a
//!   `Database` + an op string + a JSON params object, it produces a
//!   `Result<Value, String>`. It has no I/O of its own, which makes it trivial
//!   to unit-test.
//!
